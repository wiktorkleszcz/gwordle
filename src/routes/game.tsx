...
function RouteComponent() {
  ...
  return (
    <div
      className={`flex flex-col gap-2 bg-stone-900 transition-colors w-screen h-screen overflow-hidden`}
    >
      <Header
        link="/"
        onHover={setIsHovered}
        classes="bg-stone-800 text-white p-3 rounded-md min-w-24 shadow-outbox-sm"
      />
